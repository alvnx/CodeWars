...
namespace Kata
{
    ...
    public class StringAverageTest
    {
        ...
        [TestCase("", "n/a")]
        [TestCase(null, "n/a")]
        [TestCase("dybtba nine five nine seven two eight nine", "n/a")]
        public void SampleTest(string input, string expect)
        {
            Assert.AreEqual(expect, Kata.Kata.AverageStringLinq(input));
        }
    }
}
